...
| End-to-end verification | The local quality gate passes, but live VM verification is blocked until the VM is upgraded from `0.6.0` and exposes v1.0 `/status`; see `docs/v1.0-verification.md`. | Step 9 |
